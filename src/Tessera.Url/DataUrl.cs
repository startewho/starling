...
public static class DataUrl
{
    ...
    /// Returns <c>false</c> for any other scheme or for malformed data URLs.
    /// </summary>
    public static bool TryDecode(Url url, out Payload payload)
    {
