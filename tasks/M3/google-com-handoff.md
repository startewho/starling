...
| B7 — end-to-end google.com smoke test | ✅ | `tests/Starling.Engine.Tests/GoogleSearchTests.cs`, `testdata/sites/{google-home,google-search-q-hello}.html` (3 offline tests passing + 1 live-gated; surfaced two real engine gaps — see follow-ups) |
...
| **B7** end-to-end google.com smoke test | claude-cody (agent) | complete (2026-05-19) |
