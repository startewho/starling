...
public class JsErrorPositionTests
{
    ...
    public void Method_call_on_missing_property_carries_position()
    {
        ...
        JsValue.ToStringValue(thrown.AsObject.Get("message")).Should().Contain("(at 1:");
    }
    ...
    public void Bare_call_to_undefined_global_carries_position()
    {
        ...
        var thrown = act.Should().Throw<JsThrow>().Which.Value;
        JsValue.ToStringValue(thrown.AsObject.Get("message")).Should().Contain("(at 2:1)");
    }
    ...
    public void New_on_undefined_carries_position()
    {
        ...
        var thrown = act.Should().Throw<JsThrow>().Which.Value;
        JsValue.ToStringValue(thrown.AsObject.Get("message")).Should().Contain("(at 1:1)");
    }
    ...
    public void Call_deep_in_a_function_reports_inner_line()
    {
        ...
        const string src = """
            ...
            """;
        var act = () => Eval(src);
        var deepThrown = act.Should().Throw<JsThrow>().Which.Value;
        JsValue.ToStringValue(deepThrown.AsObject.Get("message")).Should().Contain("(at 3:");
    }
    ...
    public void Position_points_at_the_column_of_the_member_expression()
    {
        ...
        var act = () => Eval(src);
        var msg = JsValue.ToStringValue(act.Should().Throw<JsThrow>().Which.Value.AsObject.Get("message"));
