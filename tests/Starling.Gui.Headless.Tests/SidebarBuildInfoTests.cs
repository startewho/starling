...
/// render engine, and layout mode — as a labelled column. This pins that they all
/// render.
/// </summary>
public class SidebarBuildInfoTests
{
    [AvaloniaFact]
    public void Footer_renders_commit_js_render_and_layout_in_a_column()
    {
        var sidebar = new Sidebar(
            new ThemeManager(), System.Array.Empty<TabInfo>(), activeId: null,
            onTabActivated: null,
            build: new BuildInfo("abc12345", "jint", "imagesharp-gpu", "incremental"));
        ...
        try
        {
            ...
            texts.Should().Contain("commit").And.Contain("js").And.Contain("render").And.Contain("layout");
            ...
            texts.Should().Contain("incremental", "the active layout mode is shown");
        }
